jQuery(function($){
    ...
    $('body').on('click','.btn-close',function(){
        var tplhelper = JSON.parse(jQuery('#tplhelper').val());
            ...
            $('.control-group').each(function(){
                ...
                if(attrClass && attrClass.search(/(before-)|(after-)/gi) != -1){
                    ...
                    if($itemFlagArr[0] == 'before'){
                        $(this).insertBefore($('#jform_params_'+$itemFlag+'').closest('.control-group'));
                    }else if($itemFlagArr[0] == 'after') {
                         $(this).insertAfter($('#jform_params_'+$itemFlag+'').closest('.control-group'));
                    }
                }
